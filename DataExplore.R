### THIS SCRIPT IS TO BETTER UNDERSTAND THE DATA AND TO BEGIN EXPLORING CSDiD ###

## The CSDiD is outdated

## I used ChatGPT and Github Copilot to help me write this script
